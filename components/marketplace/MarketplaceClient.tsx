...
//     if (countDisplay === target) return;
//     const step = target > countDisplay ? 1 : -1;
//     const timer = setInterval(() => {
//       setCountDisplay((c) => {
//         if (c === target) { clearInterval(timer); return c; }
//         return c + step;
//       });
//     }, 16);
...
//       <div
//         ref={filterBarRef}
//         className={cn("mp-filter-bar", stuck && "mp-filter-bar--stuck")}
//       >
//         {/* Search */}
//         <div className="mp-search">
//           <svg className="mp-search__icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
//             <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 15.803a7.5 7.5 0 0010.607 10.607z" />
//           </svg>
//           <input
//             type="search"
...
//                 type="button"
//                 onClick={() => setCategory(cat)}
//                 className={cn("mp-cat-pill", active && "mp-cat-pill--active")}
//               >
//                 <span className="mp-cat-pill__icon">
//                   {CATEGORY_ICONS[cat] ?? "✦"}
//                 </span>
//                 <span className="mp-cat-pill__label">{cat}</span>
//               </button>
//             );
//           })}
//         </div>
...
//         <p className="mp-meta__count">
//           <span className="mp-meta__num">{countDisplay}</span>
//           <span className="mp-meta__label">
//             {filtered.length === 1 ? " piece" : " pieces"}
//             {category !== "All" && (
//               <> in <em>{category}</em></>
//             )}
...
//         <EmptyState
//           title="No handmade pieces yet"
//           description="The marketplace is empty until artisans list their work."
//           actionLabel="Become an artisan"
//           actionHref="/auth/signup?role=creator"
//         />
//       ) : filtered.length === 0 ? (
...
//             <ProductCard key={product.id} product={product} priority={i < 6} index={i} />
//           ))}
//         </div>
//       )}
//     </>
